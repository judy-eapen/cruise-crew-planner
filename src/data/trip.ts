...
const ACTIVITY_ROWS: Omit<Activity, "ticketLink" | "ageNotesYounger" | "ageNotesOlder">[] = [
  ...
  { id: "DC", name: "Discovery Cove", type: "full", adultPrice: 250, childPrice: 250, category: "Attraction", ageFit: "check", area: "orlando", star: false, estimate: true, note: "All-inclusive day resort; AGES 6+ ONLY — the 4-5yos can't attend" },
