...
const ACTIVITY_ROWS: Omit<Activity, "ticketLink">[] = [
  ...
  { id: "EPIC", name: "Universal Epic Universe", type: "full", adultPrice: 160, childPrice: 155, category: "Theme park", ageFit: "all", area: "orlando", star: true, estimate: true, note: "The new park — Super Nintendo World + Harry Potter Ministry of Magic; book early" },
