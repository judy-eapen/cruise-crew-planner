...
// This module is the single data source for v0; Supabase replaces it in v1.
...
export const FLIGHTS: Flight[] = (Object.keys(FARES) as OptionId[]).flatMap((optionId) =>
...
export const ITINERARY_SLOTS: ItinerarySlot[] = [
