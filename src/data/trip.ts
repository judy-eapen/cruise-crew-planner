...
// Ticket links + age notes start empty in the seed — real content lands via /admin or the v4 SQL files.
const ACTIVITY_ROWS: Omit<Activity, "ticketLink" | "ageNotesYounger" | "ageNotesOlder">[] = [
  ...
  { id: "AK", name: "Animal Kingdom", type: "full", adultPrice: 145, childPrice: 135, category: "Theme park", ageFit: "all", area: "orlando", star: false, estimate: true, note: "All ages love the safari" },
  { id: "HS", name: "Hollywood Studios", type: "full", adultPrice: 160, childPrice: 150, category: "Theme park", ageFit: "all", area: "orlando", star: false, estimate: true, note: "Star Wars / Toy Story spans the whole age range" },
  ...
  { id: "LEGO", name: "LEGOLAND Florida", type: "full", adultPrice: 105, childPrice: 95, category: "Theme park", ageFit: "younger", area: "daytrip", star: false, estimate: true, note: "Especially good for the 4–10yos; ~45 min drive" },
  ...
  { id: "KSC", name: "Kennedy Space Center", type: "half", adultPrice: 80, childPrice: 70, category: "Attraction", ageFit: "older", area: "port", star: true, estimate: true, note: "Near Port Canaveral — great on disembark day; best for 8+, hands-on exhibits help the littles" },
  { id: "OSC", name: "Orlando Science Center", type: "half", adultPrice: 26, childPrice: 21, category: "Attraction", ageFit: "all", area: "orlando", star: false, estimate: true, note: "Hands-on for literally every kid age in the group" },
  { id: "CRAYOLA", name: "Crayola Experience", type: "half", adultPrice: 30, childPrice: 30, category: "Attraction", ageFit: "younger", area: "orlando", star: false, estimate: true, note: "Especially good for the 4–8yos" },
  { id: "WW", name: "WonderWorks", type: "half", adultPrice: 40, childPrice: 30, category: "Attraction", ageFit: "all", area: "orlando", star: false, estimate: true, note: "Whole age range" },
  ...
  { id: "CW", name: "CityWalk at Universal", type: "half", adultPrice: 0, childPrice: 0, category: "Free / low cost", ageFit: "all", area: "orlando", star: false, estimate: false },
  { id: "WPBOAT", name: "Winter Park Scenic Boat Tour", type: "half", adultPrice: 18, childPrice: 9, category: "Free / low cost", ageFit: "all", area: "orlando", star: false, estimate: true, note: "Relaxing for the whole mixed group" },
  { id: "POOL", name: "Hotel pool time", type: "half", adultPrice: 0, childPrice: 0, category: "Free / low cost", ageFit: "all", area: "orlando", star: false, estimate: false, note: "Universal win with 14 kids" },
  ...
  { id: "BEACH", name: "Beach day (Cocoa Beach / New Smyrna)", type: "full", adultPrice: 0, childPrice: 0, category: "Free / low cost", ageFit: "all", area: "daytrip", star: false, estimate: false },
  { id: "US", name: "Universal Studios", type: "full", adultPrice: 140, childPrice: 135, category: "Theme park", ageFit: "older", area: "orlando", star: false, estimate: true, note: "Harry Potter Diagon Alley — Gringotts ride 42in; kids under ~42in mostly wands + shows. Hogwarts Express needs a 2-park ticket" },
  { id: "EPIC", name: "Universal Epic Universe", type: "full", adultPrice: 160, childPrice: 155, category: "Theme park", ageFit: "all", area: "orlando", star: true, estimate: true, note: "Most kid-friendly big park: HP Ministry + Mario Kart 40in, Yoshi 34in — most 5yos+ ride lots; big coasters 48in" },
  { id: "IOA", name: "Islands of Adventure", type: "full", adultPrice: 140, childPrice: 135, category: "Theme park", ageFit: "older", area: "orlando", star: false, estimate: true, note: "HP Hogsmeade: Hagrid's + Forbidden Journey need 48in — best for the 10+ crowd; littles get Hippogriff (36in) + wands" },
  ...
  { id: "DC", name: "Discovery Cove", type: "full", adultPrice: 230, childPrice: 230, category: "Attraction", ageFit: "check", area: "orlando", star: false, estimate: true, note: "All-inclusive Day Resort, ages 3+; dolphin-swim package ~$250 and swimmers must be 6+" },
  { id: "EOLA", name: "Lake Eola Park", type: "half", adultPrice: 0, childPrice: 10, category: "Free / low cost", ageFit: "all", area: "orlando", star: false, estimate: true, note: "Swan boats; especially nice for the youngest kids" },
...
const ACTIVITIES: Activity[] = ACTIVITY_ROWS.map((a) => ({ ...a, ticketLink: "", ageNotesYounger: "", ageNotesOlder: "" }));
